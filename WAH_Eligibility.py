...
lookback_beginning = decide_fm_beginning(
...
last_lookback_beginning = decide_fm_beginning(
...
conclusion = '<br><p><span style="color:black">If you have any questions, please reach out <a href="mailto:DL-Video-Repair-Reporting@charter.com"><span style="font-size: 12.0pt">here</span></a><span style="font-size:12.0pt;color:black">.</span></span></p></br>'
...
newMail.To = 'DL-CS-Video-Repair-Managers@charter.com'
newMail.CC = 'DL-Video-Repair-Reporting@charter.com'
